...
<body <?php body_class('bg-white text-zinc-900 antialiased'); ?>>
    ...
    <div id="site-loader"
        class="fixed inset-0 z-[100] flex items-center justify-center bg-[#bcb8b3] opacity-100 transition-opacity duration-700">
    ...
    <div id="page" class="min-h-screen flex flex-col opacity-0 transition-opacity duration-700">
        ...
        <header id="site-header" class="relative z-[60] bg-[#D4CFC7] p-6 transition-colors duration-300">
            <div class="flex items-center justify-between">
                ...
                <button id="site-menu-toggle" type="button" aria-label="Open menu" aria-expanded="false"
                    ...
                    <span class="site-menu-line site-menu-line-top absolute block h-px w-8 -translate-y-1 bg-current transition-transform duration-300"></span>
                    <span class="site-menu-line site-menu-line-bottom absolute block h-px w-8 translate-y-1 bg-current transition-transform duration-300"></span>
                </button>
            </div>
        </header>
        ...
        <div id="site-menu-overlay"
            ...
            <div class="mx-0 bg-[#bcb8b3]/95 px-6 md:px-12 pt-12 pb-8 shadow-xl backdrop-blur-[1px]">
