...
<section
    ...
    <nav
        class="relative z-10 flex flex-col md:flex-row items-center gap-10 text-zinc-800 text-[12px] bg-beige-1 px-14 py-8 md:px-8 tracking-[0.45em] uppercase font-medium md:gap-16">
